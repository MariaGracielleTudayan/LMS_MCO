								...
								<form action="" class="form-control" method="post" name="idn">
									...
									<table class="table table-bordered">
                                        ...
                                        <tr>
                                         ...
                                         <tr>
                                            <td>
                                               <input type="text" class="form-control" name="department"  value="<?php echo $departmet; ?>"> 
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                    ...
                                    if (isset($_POST["submit2"])) {
                                      ...
                                      $res= mysqli_query($link, "select * from add_book where books_name='$_POST[booksname]' ");
                                       ...
                                       if ($qty==0) {
                                          ...
                                          mysqli_query($link, "insert into t_issuebook values('','$_SESSION[utype]','$_SESSION[idno]','$_POST[name]','$_POST[department]','$_POST[phone]','$_POST[email]','$_POST[booksname]','$_POST[booksissuedate]','$_POST[booksreturndate]','$_SESSION[tusername]') ");
