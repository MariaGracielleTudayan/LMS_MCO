        ...
        <?php
            ...
            if (isset($_POST["submit"])) {
                ...
                move_uploaded_file($_FILES["file"]["tmp_name"],$filepath);
                 ...
                 mysqli_query($link, "insert into add_book values('','$_POST[booksname]','$imagepath','$_POST[bauthorname]','$_POST[bpubname]','$_POST[bquantity]','$_POST[bavailability]','$_SESSION[username]','$filepath')");
